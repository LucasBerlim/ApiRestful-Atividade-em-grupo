...
public class ProdutoController {
	...
	description = "Dado um determinado id, será retornado os produtos com as informações gerais.")
	...
	description = "Dado um determinado id, será retornado um produto com as informações gerais do produto.")
	@ApiResponses(value = {
	...
	description = "Criar um novo produto e retornar os detalhes do produto criado")
	@ApiResponses(value = {
	...
	description = "Apagar um produto de acordo com o id fornecido")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "Não foi encontrado o produto pelo id informado. Verifique!"),
