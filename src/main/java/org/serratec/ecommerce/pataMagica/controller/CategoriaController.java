...
public class CategoriaController {
	...
	description = "Dado um determinado id, será retornada as categorias com as informações gerais.")
	...
	description = "Dado um determinado id, será retornada uma categoria com as informações gerais da categoria.")
	@ApiResponses(value = {
	...
	description = "Criar uma nova categoria e retornar os detalhes da categoria criada")
	@ApiResponses(value = {
	...
	description = "Apagar uma categoria de acordo com o id fornecido")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "Não foi encontrada a categoria pelo id informado. Verifique!"),
	...
	@PutMapping("/{id}")
	@Operation(summary = "Alterar uma nova categoria",
	description = "Apagar uma categoria de acordo com o id fornecido")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "Não foi encontrada a categoria pelo id informado. Verifique!"),
